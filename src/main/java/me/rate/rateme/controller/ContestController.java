...
public class ContestController {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Page of contests"),
            @ApiResponse(responseCode = "401", description = "Unauthorized access") })
    public ResponseEntity<List<TaskModel>> getAllCompanyContestTasks(
            @PathVariable String contestName, @RequestParam String companyName) {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Task"),
            ...
            @ApiResponse(responseCode = "404",
                    description = "Company or contest or task not found") })
    public ResponseEntity<TaskModel> getTask(@PathVariable String contestName,
                                             @PathVariable String taskName,
                                             @RequestParam String companyName) {
        return ResponseEntity.ok(
                contestService.findContestTask(companyName, contestName, taskName));
    }
