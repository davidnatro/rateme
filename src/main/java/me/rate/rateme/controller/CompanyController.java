...
public class CompanyController {
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Page of companies"),
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Company"),
          @ApiResponse(responseCode = "401", description = "Unauthorized access"),
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Created company"),
          @ApiResponse(responseCode = "401", description = "Unauthorized access"),
          @ApiResponse(responseCode = "409", description = "Company already exists") })
  public ResponseEntity<CompanyModel> createCompany(@Valid @RequestBody CreateCompanyDto request) {
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Updated company"),
          @ApiResponse(responseCode = "401", description = "Unauthorized access"),
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Hired employee"),
          @ApiResponse(responseCode = "401", description = "Unauthorized access"),
          @ApiResponse(responseCode = "403", description = "Forbidden access"),
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Deleted company"),
          @ApiResponse(responseCode = "401", description = "Unauthorized access"),
          @ApiResponse(responseCode = "403", description = "Forbidden access"),
          @ApiResponse(responseCode = "404", description = "Company not found") })
  ...
  @ApiResponses(
      value = { @ApiResponse(responseCode = "200", description = "Fired employee"),
          @ApiResponse(responseCode = "401", description = "Unauthorized access"),
          @ApiResponse(responseCode = "403", description = "Forbidden access"),
          @ApiResponse(responseCode = "404", description = "Company or user not found") })
